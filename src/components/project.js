                ...
                <div className='flex flex-col md:flex-row px-10 gap-5'>
                    ...
                    <div className='relative'>
                        ...
                        <div className='project-desc'>
                            <p className='text-center px-10 py-20'>TODO list app by using HTML/CSS, Javascript <br/>
                            <span><a href='https://gunasri3105.github.io/todo-app/'>Click Here</a></span> </p>
                        </div>
                    </div>
                    <div className='relative'>
                        <img src={Project3} className='h-[250px] w-[400px]' alt='Project3' />
                        <div className='project-desc'>
                            <p className='text-center px-10 py-20'>Responsive E-Commerce website by using React.js <br/>
                            <span><a href='https://gunasri3105.github.io/e-commerce/'>Click Here</a></span></p>  
                        </div>
                    </div>
                    <div className='relative'>
